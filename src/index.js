...
app.get("/sse", (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, (0, mcpServer_js_1.createMcpServer)()];
            case 1:
                server = _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                console.error("Error in /sse route:", error_1);
        ...
        switch (_a.label) {
            case 0:
                if (!transport) {
                    ...
                    return [2 /*return*/, res.status(400).json({ error: "SSE not yet connected" })];
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 3:
                err_1 = _a.sent();
                console.error("❌ Error handling message:", err_1);
...
app.listen(port, "0.0.0.0", function () {
    console.log("\uD83D\uDE80 MCP server listening at http://localhost:".concat(port));
});
